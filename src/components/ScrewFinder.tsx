    ...
    return (
      <section className="px-4 md:px-6 pb-8">
        <button
          ...
          className="group max-w-4xl mx-auto w-full flex items-center gap-5 bg-diose-black hover:brightness-125 rounded-3xl px-6 md:px-8 py-5 md:py-6 text-left cursor-pointer transition-[filter] duration-200"
        >
          <div className="shrink-0 w-14 h-14 rounded-full bg-white flex items-center justify-center transition-transform duration-200 group-hover:scale-110 group-hover:rotate-12">
            <BoltIcon size={34} />
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-[10px] font-semibold tracking-[0.18em] uppercase text-diose-gold">
              Tornillería
            </div>
            <div className="font-heading text-lg md:text-xl text-white tracking-[0.02em] leading-tight">
              ¿No sabes qué tornillo llevas? Encuéntralo en pantalla
            </div>
            <p className="text-[12px] text-white/50 mt-0.5 hidden sm:block">
              Recomendado usar desde una computadora, por el tamaño de pantalla.
            </p>
          </div>
          <div className="shrink-0 w-10 h-10 rounded-full bg-white flex items-center justify-center transition-transform duration-200 group-hover:translate-x-1">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#070707" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
